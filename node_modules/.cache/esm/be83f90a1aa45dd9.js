_1aa‍.x([["registerProject",()=>registerProject],["updateProject",()=>updateProject],["deleteProject",()=>deleteProject],["getProject",()=>getProject],["getAllProjects",()=>getAllProjects]]);const { Projects, Categories } = require("../models/projects");
...
// const { Course, Section } = require("../models/course");
    ...
    try {
        const allProject = await Projects.find().count();
